...
public class ReconstructItinerary {
    ...
    boolean recHelper(final List<String> path, final String source, final HashMap<String, List<Boolean>> visited,
    ...
    class EulerianPath {
        ...
        // used.
        // first vertex that we got stuck at would be the end point of our Eulerian
