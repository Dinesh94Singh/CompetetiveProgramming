...
public class CourseSchedule2 {
    public int[] findOrder(final int n, final int[][] p) {
        ...
        if(deque.isEmpty()) { return new int[]{}; } // graph lo cycle detection - topological sort is one way to do => dfs/bfs/ disjoint set union
